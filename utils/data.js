...
export const myEOTeam = [
  {
    id: 1,
    imageUrl: '/teams/Sanjeev-Shenoy.webp',
    name: 'Sanjeev Shenoy',
    designation: 'President',
  },
  {
    id: 2,
    imageUrl: '/teams/Gita-Ramanan.webp',
    name: 'Gita Ramanan',
    designation: 'Learning Chair',
  },
  {
    id: 3,
    imageUrl: '/teams/Manish-Giria.webp',
    name: 'Manish Giria',
    designation: 'Co-Learning Chair',
  },
  {
    id: 4,
    imageUrl: '/teams/Nikhil-Bhandarkar.webp',
    name: 'Nikhil Bhandarkar',
    designation: 'Membership Chair',
  },
  {
    id: 5,
    imageUrl: '/teams/Neha-Bagaria.webp',
    name: 'Neha Bagaria',
    designation: 'Co-Membership Chair',
  },
  {
    id: 6,
    imageUrl: '/teams/Shravan-Gupta.webp',
    name: 'Shravan Gupta',
    designation: 'Governance Chair',
  },
  {
    id: 7,
    imageUrl: '/teams/Achal-Goenka.webp',
    name: 'Achal Goenka',
    designation: 'Platinum Chair',
  },
  {
    id: 8,
    imageUrl: '/teams/Rohit-Mittal.webp',
    name: 'Rohit Mittal',
    designation: 'Finance Chair',
  },
  {
    id: 9,
    imageUrl: '/teams/Kaushik-Narayan.webp',
    name: 'Kaushik Narayan',
    designation: 'Communication Chair',
  },
  {
    id: 10,
    imageUrl: '/teams/Kamala-Naganand.webp',
    name: 'Kamala Naganand',
    designation: 'Strategic Alliance <br/>& Sponsorship Chair',
  },
  {
    id: 11,
    imageUrl: '/teams/Suraj-Sreenath.webp',
    name: 'Suraj Sreenath',
    designation: 'Forum Chair',
  },
  {
    id: 12,
    imageUrl: '/teams/Zonu-Reddy.webp',
    name: 'Zonu Reddy',
    designation: 'Integration Chair',
  },
  {
    id: 13,
    imageUrl: '/teams/Sheena-Jones.webp',
    name: 'Sheena Jones',
    designation: 'SLP Chair',
  },
]
...
export const industryServedData = [
  ...
  {
    id: 3,
    imageUrl: '/industriesServed/image03.png',
    category: 'Automotive',
  },
  {
    id: 5,
...
export const memberWhyJoinEOData = [
  {
    id: 1,
    icon: '/membership/icon01.png',
    title: 'Direct Peer-to-Peer Learning',
  },
  {
    id: 2,
    icon: '/membership/icon02.png',
    title: 'Once-in-a-Lifetime Experiences',
  },
  {
    id: 3,
    icon: '/membership/icon03.png',
    title: 'Connections to Experts',
  },
]

export const membershipCriteriaData = [
  {
    id: 1,
    tag: 'Role',
    desc: [
...
export const globalCommunityData = [
  ...
  {
    id: 3,
    iconUrl: '/about/globalCommunity/09.png',
    title: 'Ambition',
...
export const coreValuesData = [
  ...
  {
    id: 2,
    iconUrl: '/about/CoreValues/icon02.png',
    title: 'Thirst for Learning',
  },
  {
    id: 3,
...
export const globalFootprintData = [
  ...
  },
  {
    id: 6,
    count: '275',
    title: 'AVERAGE NUMBER OF EO',
  },
]

export const gseaEventData = [
  {
    id: 1,
