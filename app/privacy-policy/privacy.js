  ...
  return (
    <div className="wpb_wrapper">
      <div className="content-sec">
        ...
        <p className="mb-4">
          a. This Website with the URL of www.riekol.com
          (&#8220;Website/Site&#8221;) and www.eokolkata.org is operated by
          Entrepreneurs Organization Kolkata (&#8220;We/Our/Us&#8221;). We are
          committed to protecting and respecting your privacy. We do collect
          your personal information and process your personal data in accordance
          with the IT Act, 2000 (21 of 2000) and other national and state laws
        ...
        <p className="mb-4">
          c. Our privacy policy is subject to change at any time without notice.
        ...
        <p className="mb-4">
          ...
          sensitive personal information held by Us without having first entered
      ...
      <div className="content-sec">
        ...
        <p className="mb-4">
          a. From you directly and through this Site: We may collect information
          through the Website when you visit. The data we collect depends on the
          context of your interactions with our Website.
        </p>
        <p className="mb-4">
          c. From other sources: We may receive information from other sources,
          such as public databases; joint marketing partners; social media
          platforms; or other third parties such as: I. Updated delivery and
          address information from our carriers or other third parties, which we
          use to correct our records and deliver your next purchase or
      ...
      <div className="content-sec">
        ...
        <p className="mb-4">
          a. We collect information primarily to provide better services to all
          of our customers.
          <br />
          b. We collect the following information from you when you use or
          signup on our Website: Name, Email, Address, Phone No, Identity
          Documents, Preferences, Interest, Industry, Business etc.
          <br />
          c. We do collect the following sensitive personal information from you
          when you use or sign up on our Website: Biometric data
          <br />
          ...
          Cookies are small data files stored on your hard drive. Among other
          ...
          <br />
          j. We will retain your information as long as we require this to
          provide you with the goods and services and for such period as
          mandated by the laws concerned.
          <br />
          k. If you opt to receive marketing correspondence from us, subscribe
      ...
      <div className="content-sec">
        <h3 className="text-2xl font-bold mb-4">How We Use Information</h3>
        <p className="mb-4">
          a. We use the information we collect primarily to provide, maintain,
      ...
      <div className="content-sec">
        <h3 className="text-2xl font-bold mb-4">Data Transfer</h3>
        <p className="mb-4">
          a. Information about our users is an important part of our business
          and we take due care to protect the same.
          <br />
          ...
          <br />
          c. We may employ other companies and individuals to perform functions
      ...
      <div className="content-sec">
        ...
        <p className="mb-4">
          a. To optimise our web presence, we use cookies. These are small text
          ...
          us to learn more about your interests, and provides you with essential
      ...
      <div className="content-sec">
        ...
        <p className="mb-4">
          a. We take due care to protect customer data. Technical measures are
          in place to prevent unauthorized or unlawful access to data and
          against accidental loss or destruction of, or damage to, data. The
          ...
          as credit card numbers, UID&#8217;s and login credentials to be
          transmitted securely.
          <br />
          c. We follow the Payment Card Industry Data Security Standard (PCI
          DSS) when handling branded credit cards from the major card schemes.
          <br />
          ...
          <br />
          e. We take reasonable steps to help protect your personal information
          ...
          for our services.
          <br />
          f. It is important for you to protect against unauthorized access to
          your password and your computers, devices, and applications. Be sure
          to sign off when you finish using a shared computer.
          <br />
          g. The information you provide to us is shared on our secure servers.
      ...
      <div className="content-sec">
        ...
        <p className="mt-3">
          a. We do not share your personal data with third parties without your
          ...
          Act, 2000 (21 of 2000) and other applicable legislation, or enter into
          a written agreement with Us requiring that the third party provide at
          least the same level of privacy protection as is required by such
          principles;
          <br />
          II. To comply with laws or to respond to lawful requests and legal
          process;
          <br />
          III. To protect the rights and property of Us, our agents, customers,
          and others including to enforce our agreements, policies, and terms of
          use;
          <br />
          IV. In an emergency, including to protect the personal safety of any
          person; and
          <br />
          V. For the purpose of a business deal (or negotiation of a business
          deal) involving the sale or transfer of all or a part of our business
          or assets (business deals may include, for example, any merger,
          financing, acquisition, divestiture, or bankruptcy transaction or
          proceeding).
        </p>
      </div>
      <div className="content-sec">
        ...
        <p className="mt-3">
          ...
          any cause of action that arose due to non-compliance with this
          section.
        </p>
      </div>
      <div className="content-sec">
        <h3>Your Information Choices And Changes</h3>
        <p className="mt-3">
          a. You can also make choices about the collection and processing of
          ...
          ongoing business relationship. You may also send requests about your
      ...
      <div className="content-sec">
        ...
        <p>
          ...
          this policy, we will change the &#8220;Last Updated&#8221; date above.
          You agree that your continued use of our services after such changes
          have been published to our services will constitute your acceptance of
          such revised policy.
        </p>
      </div>
      <div className="content-sec">
        <h3>Newsletter</h3>
        <p className="mt-3">
          a. Following your subscription to the newsletter, your e-mail address
        ...
        <p className="mt-5">
          ...
          Secretary-General
          <br />
          Entrepreneurs Organization Kolkata
          <br />
          687, Eastern Metropolitan Bypass, Anandapur, East Kolkata Twp,
